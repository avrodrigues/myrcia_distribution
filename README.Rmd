...
In the folder `clean` are the scripts to organize the data for the modeling. In the folder `do` are the scripts for model fitting, evaluation and model selection.
